...
public class StateManager {
	...
	public static void main(String[] args) {
		...
		// Q1
		Class a = findClassInPackage("A", umlP);
		List<Behavior> stateMachines = getStateMachinesFromClass(a);
		...
		for (Behavior stateMachine : stateMachines) {
			...
			System.out.println("\tOperations contenues dans la machine à état : ");
